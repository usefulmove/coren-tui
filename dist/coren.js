...
const unfoldRange = (start, end, step) => {
...
export class CorenInterpreter {
    ...
    loadState = { started: false, name: "", depth: 0 };
    magic8 = new Map([
        [0, "it is certain"],
    ...
    registerCommands() {
        ...
        // RGB
        const scaleHex = (factor) => (rgb) => rgbToHex(clamp255(rgb[0] * factor), clamp255(rgb[1] * factor), clamp255(rgb[2] * factor));
